...
def populate_data():
    with app.app_context():  # Corrección para trabajar dentro del contexto de la aplicación
        ...
        # Populate Users
        users = [
            User(id=1, username='HenryDiaz', email='Henry.Diaz@dummy.com', name='Henry', lastname='Diaz', password_hash=generate_password_hash('Diaz_3421'), role='Owner', meeting_center_id=1),
            User(id=2, username='OscarCampos', email='Oscar.Campos@dummy.com', name='Oscar', lastname='Campos', password_hash=generate_password_hash('Obispo'), role='User', meeting_center_id=1),
            User(id=3, username='CameronWexels', email='Cameron.Wexels@dummy.com', name='Cameron', lastname='Wexels', password_hash=generate_password_hash('Secretario'), role='User', meeting_center_id=1),
            User(id=4, username='JulioOzuna', email='Julio.Ozuna@dummy.com', name='Julio', lastname='Ozuna', password_hash=generate_password_hash('Consejero'), role='User', meeting_center_id=1),
            User(id=5, username='AnuarGiraldo', email='Anuar.Giraldo@dummy.com', name='Anuar', lastname='Giraldo', password_hash=generate_password_hash('Consejero'), role='Admin', meeting_center_id=1),
            User(id=6, username='JeffreyBaron', email='Jeffrey.Baron@dummy.com', name='Jeffrey', lastname='Baron', password_hash=generate_password_hash('Secretario'), role='User', meeting_center_id=1),
            User(id=7, username='PatrickCannon', email='Patrick.Cannon@dummy.com', name='Patrick', lastname='Cannon', password_hash=generate_password_hash('Presidente'), role='Admin', meeting_center_id=1),
            User(id=8, username='LibertadRamirez', email='Libertad.Ramirez@dummy.com', name='Libertad', lastname='Ramirez', password_hash=generate_password_hash('Presidenta'), role='Admin', meeting_center_id=1),
            User(id=9, username='NoemiSandoval', email='Noemi.Sandoval@dummy.com', name='Noemi', lastname='Sandoval', password_hash=generate_password_hash('Presidenta'), role='Admin', meeting_center_id=1),
            User(id=10, username='JeniferWexels', email='Jenifer.Wexels@dummy.com', name='Jenifer', lastname='Wexels', password_hash=generate_password_hash('Secretaria'), role='User', meeting_center_id=1),
            User(id=11, username='CristobalMartinez', email='Cristobal.Martinez@dummy.com', name='Cristobal', lastname='Martinez', password_hash=generate_password_hash('Presidente'), role='Admin', meeting_center_id=1),
            User(id=12, username='JuanSantaMaria', email='Juan.SantaMaria@dummy.com', name='Juan', lastname='SantaMaria', password_hash=generate_password_hash('Secretario'), role='User', meeting_center_id=1),
            User(id=13, username='DetzaniVanderpool', email='Detzani.Vanderpool@dummy.com', name='Detzani', lastname='Vanderpool', password_hash=generate_password_hash('Presidenta'), role='Admin', meeting_center_id=1),
            User(id=14, username='ClaudiaEwell', email='Claudia.Ewell@dummy.com', name='Claudia', lastname='Ewell', password_hash=generate_password_hash('Secretaria'), role='User', meeting_center_id=1)
