...
def get_swal_texts():
    return {    
        ...
        'editMemberTooltip'       : _("Edit Member"),
        'errorMessage'            : _("There was a problem saving the data"),
        'errorTitle'              : _("¡Error!"),
        'great'                   : _("Great!"),
        ...
        'paginationNext'          : _("Next"),
        'paginationPrevious'      : _("Previous"),
        'profileMemberTooltip'    : _("See profile of"),
